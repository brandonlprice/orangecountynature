...
/* Basemap Layers */
            ...
            var openstreet = L.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Light_Gray_Base/MapServer/tile/{z}/{y}/{x}", {
					maxZoom: 19,
...
var parks = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
	  let photo_content = ""
  if(feature.properties.photo1) { // null is falsy
    photo_content = '<img src="'+ feature.properties.photo1 +'" style="width:23em;height:22em;display: block;margin-left: auto;margin-right: auto;width: 80%;"><button class="btn btn-light btn-sm btn-secondary" style="display: block;margin-left: auto;margin-right: auto;width: 50%;">Next</button>'
  }
  if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Address</th><td>" + feature.properties.ADDRESS1 + "</td></tr>" + "<tr><th>Phone</th><td>" + feature.properties.TEL + "</td></tr>" + "<tr><th>Website</th><td><a class='url-break' href='" + feature.properties.URL + "' target='_blank'>" + feature.properties.URL + "</a></td></tr>"+ "<tr><th>Images</th><td>" + photo_content + "</td></tr>" + "<table>";
      layer.on({
        click: function (e) {
...
var baseLayers = {
  ...
  "Aerial Imagery": clarity
};

var groupedOverlays = {
  "Gathering Spaces": {
    
	"&nbsp;&nbsp;<img src='assets/img/theater.png' width='24' height='28'>": parkLayer
  }//,
  //"Reference": {
